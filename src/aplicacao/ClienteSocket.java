...
public class ClienteSocket extends javax.swing.JFrame {
    ...
    private final long tamanhoPermitidoKB = 8192; //Igual a 8MB
    ...
    private void enviarArquivoServidor() {
        if (validaArquivo()) {
            try {
                ...
                bf.close();
                socket.close();
                JOptionPane.showMessageDialog(null, "Arquivo enviado para o diretorio " + jTextFieldDiretorio.getText() + " com sucesso!");
    ...
    private boolean validaArquivo() {
        if (arquivo.getTamanhoKB() > tamanhoPermitidoKB) {
            JOptionPane.showMessageDialog(this,
                    "Arquivo com tamanho acima do máximo permitido! (" + (tamanhoPermitidoKB / 1024) + " MB)");
            return false;
        } else {
            return true;
        }
